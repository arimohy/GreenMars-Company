			...
			<div class="row">
				...
				<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12 mb60">
					<div class="crumina-module crumina-heading">
						...
						<h2 class="heading-title">Mira nuestros videos y descubre todo lo que puedes hacer y vender con nuestra apps</h2>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12">
					<div class="crumina-module crumina-heading">
						<h2 class="heading-title">Descarga <span class="c-primary">Mayorista Disitribuidor</span> ahora!</h2>
